<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            Production # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            Production
        </v-card-title >
        ...
        <v-card-text>
            <Date label="JobDt" v-model="value.jobDt" :editMode="editMode"/>
            <String label="UserId" v-model="value.userId" :editMode="editMode"/>
            <Number label="EqmtId" v-model="value.eqmtId" :editMode="editMode"/>
