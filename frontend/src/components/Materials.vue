<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            Materials # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            Materials
        </v-card-title >
        ...
        <v-card-text>
            ...
            <String label="WrhsCnt" v-model="value.wrhsCnt" :editMode="editMode"/>
            <String label="CoptrCd" v-model="value.coptrCd" :editMode="editMode"/>
        </v-card-text>
